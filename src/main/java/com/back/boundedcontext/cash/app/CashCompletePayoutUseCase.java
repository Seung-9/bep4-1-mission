...
public class CashCompletePayoutUseCase {
    ...
    public void completePayout(PayoutDto payout) {
        ...
        holdingWallet.debit(
                payout.amount(),
                payout.payeeSystem() ? CashLog.EventType.정산지급__상품판매_수수료 : CashLog.EventType.정산지급__상품판매_대금,
        ...
        payeeWallet.credit(
                payout.amount(),
                payout.payeeSystem() ? CashLog.EventType.정산수령__상품판매_수수료 : CashLog.EventType.정산수령__상품판매_대금,
                payout.getModelTypeCode(),
                payout.id()
        );
    }
